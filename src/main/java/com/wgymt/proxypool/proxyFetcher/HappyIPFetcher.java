...
@Component
@FetcherType(value = "HappyIP")
public class HappyIPFetcher implements ProxyFetcher {

    private final Logger logger = LoggerFactory.getLogger(HappyIPFetcher.class);
    ...
    public List<String> fetch() {
        ...
        logger.info("开心ip网站获取了: {}", ips.size());
        return ips;
    }
    ...
    private List<String> getIps(String url) {
        ...
        try {
            ...
            Elements elements = document.selectXpath("//table[@class='active']//tr");
    ...
    private List<String> getPageUrls() {
        ...
        for (int i = 1; i < 6; i++) {
            urls.add(FetcherConstants.HappyIP_URL_1.replace("page", String.valueOf(i)));
            urls.add(FetcherConstants.HappyIP_URL_2.replace("page", String.valueOf(i)));
        }
        return urls;
    }
